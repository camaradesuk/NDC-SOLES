ui_tab_about <- tabItem(tabName = "about",
                        ...
                        fluidRow(
                          ...
                          box(width = 12,
                              ...
                              solidHeader = TRUE,
                              collapsible = FALSE,
                              p("Learn more about SOLES projects and  the code underlying this app on our", 
                                strong(tags$a(href= "https://camaradesuk.github.io/soles-projects/", "SOLES project website.")),
                                "Thank you to SOLES Team members: Emma Wilson, Kaitlyn Hair, Sean Smith, Alexandra Bannach-Brown, and Maria Economou.
                                We’re working to continually improve the NDC-SOLES app. Give us your feedback via this ",
