...
ui_tab_openresearch <- tabItem(tabName = "data-summary-openresearch",
        ...
        fluidRow(
          ...
          valueBox(
            ...
            color = "secondary",
            value = span(round(length(oa_tag$uid[which(oa_tag$is_oa=="open")])/length(oa_tag$uid)*100,1), "%",
          ...
          valueBox(
            ...
            color = "secondary",
            value = span(round(length(transparency$uid[which(transparency$is_open_data=="available")])/length(transparency$uid)*100,1), "%",
                           style = "font-size: 300%; color: white;"),
          ...
          valueBox(
            ...
            color = "secondary",
            value = span(round(length(transparency$uid[which(transparency$is_open_code=="available")])/length(transparency$uid)*100,1), "%",
                           style = "font-size: 300%; color: white;"),
            icon = icon("code")
          )
        ),
