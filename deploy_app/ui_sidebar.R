ui_sidebar <- sidebarMenu(
  ...
  bs4SidebarMenuItem("Institutions", tabName = "data-summary-location", icon = icon("earth-europe", verify_fa = FALSE)),
  bs4SidebarMenuItem("Experimental details", tabName = "data-trends-model", icon = icon("microscope"), startExpanded = FALSE),
