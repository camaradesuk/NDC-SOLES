ui_included_studies <- tabItem(tabName = "studies-included-summary-dc",
        fluidRow(
          valueBox(
            width=3,
            subtitle = tags$p("Publications this week", style = "font-size: 120%; color: black;"),
            color = "secondary",
          ...
          valueBox(
            width=3,
            subtitle = tags$p("Publications this month", style = "font-size: 120%; color: black;"),
            color = "secondary",
          ...
          valueBox(
            width=3,
            subtitle = tags$p("Publications in the last year", style = "font-size: 120%; color: black;"),
            color = "secondary",
          ...
          valueBox(
            width=3,
            subtitle = tags$p("Total publications", style = "font-size: 150%; color: white;"),
            color = "primary",
